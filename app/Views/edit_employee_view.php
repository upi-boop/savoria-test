...
<body>
    <div class="container mt-5">
        <h1>Edit Karyawan</h1>
        <form action="<?= site_url('employees/' . $employee['m_employee_id']) ?>" method="POST">
            <div class="row">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" name="alamat" required><?= $employee['alamat'] ?></textarea>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="form-control" name="hubungan_keluarga[]">
                                    <option value="Ayah" <?= $member['hubungan_keluarga'] == 'Ayah' ? 'selected' : '' ?>>Ayah</option>
                                    <option value="Ibu" <?= $member['hubungan_keluarga'] == 'Ibu' ? 'selected' : '' ?>>Ibu</option>
                                    <option value="Anak" <?= $member['hubungan_keluarga'] == 'Anak' ? 'selected' : '' ?>>Anak</option>
                                    <option value="Saudara" <?= $member['hubungan_keluarga'] == 'Saudara' ? 'selected' : '' ?>>Saudara</option>
                                </select>
                            </td>
                            <td><input type="text" class="form-control" name="nama_keluarga[]" value="<?= $member['nama_anggota_keluarga'] ?>"></td>
                            <td><input type="date" class="form-control" name="tanggal_lahir_keluarga[]" value="<?= $member['tanggal_lahir_anggota_keluarga'] ?>"></td>
                        </tr>
                    <?php endforeach; ?>
                    <tr>
            ...
            <a href="<?= site_url('employees') ?>" class="btn btn-danger">Batal</a>
        </form>
    </div>
